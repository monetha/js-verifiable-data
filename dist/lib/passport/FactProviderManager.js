...
var FactProviderManager = /** @class */ (function () {
    function FactProviderManager(harmony, factProviderRegistryAddress) {
        this.harmony = harmony;
        this.factProviderRegistryAddress = factProviderRegistryAddress;
    }
    FactProviderManager.prototype.getContract = function () {
        return rawContracts_1.initFactProviderRegistryContract(this.harmony, this.factProviderRegistryAddress);
    };
    /**
    ...
    FactProviderManager.prototype.setInfo = function (factProviderAddress, info, registryOwner) {
        var method = this.getContract().methods.setFactProviderInfo(factProviderAddress, info.name, info.passport || emptyAddress, info.website || '');
        return tx_1.configureSendMethod(this.harmony, method, registryOwner);
    };
    /**
    ...
    FactProviderManager.prototype.deleteInfo = function (factProviderAddress, registryOwner) {
        var method = this.getContract().methods.deleteFactProviderInfo(factProviderAddress);
        return tx_1.configureSendMethod(this.harmony, method, registryOwner);
    };
    /**
    ...
    FactProviderManager.prototype.getInfo = function (factProviderAddress) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, tx_1.callMethod(this.getContract().methods.factProviders(factProviderAddress))];
                    case 1:
                        result = _a.sent();
