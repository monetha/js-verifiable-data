...
export declare class PrivateDataExchanger {
    ...
    constructor(harmony: Harmony, passportAddress: Address, currentTimeGetter?: CurrentTimeGetter);
    private getContract;
    /**
 ...
 */
export declare function getExchangeIndexFromReceipt(receipt: TransasctionReceipt): string;
