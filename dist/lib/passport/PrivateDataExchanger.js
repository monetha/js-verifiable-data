...
var PrivateDataExchanger = /** @class */ (function () {
    function PrivateDataExchanger(harmony, passportAddress, currentTimeGetter) {
    ...
    PrivateDataExchanger.prototype.getContract = function () {
    ...
    PrivateDataExchanger.prototype.propose = function (factKey, factProviderAddress, exchangeStakeWei, requesterAddress, txExecutor, rand, onExchangeKey) {
        return __awaiter(this, void 0, void 0, function () {
            var ownerPublicKeyBytes, ownerPubKeyPair, ecies, exchangeKeyData, encryptedExchangeKey, contract, method, txConfig, receipt, exchangeIdx;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new proto_1.PassportOwnership(this.harmony, this.passportAddress).getOwnerPublicKey()];
                    case 1:
                    ...
                    case 2:
                        ...
                        method = contract.methods.proposePrivateDataExchange(factProviderAddress, contract_1.formatBytes32String(factKey), "0x" + Buffer.from(encryptedExchangeKey).toString('hex'), exchangeKeyData.skmHash);
                        return [4 /*yield*/, tx_1.configureSendMethod(this.harmony, method, requesterAddress, {
    ...
    PrivateDataExchanger.prototype.accept = function (exchangeIndex, passportOwnerPrivateKey, ipfsClient, txExecutor) {
        return __awaiter(this, void 0, void 0, function () {
            var status, nearFuture, account, exchangePubKeyPair, passportOwnerPrivateKeyPair, ecies, exchangeKey, privateReader, dataSecretKey, encryptedDataSecretKey, contract, method, txConfig;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        try {
                            account = this.harmony.wallet.addByPrivateKey("0x" + passportOwnerPrivateKey.replace('0x', ''));
                    ...
                    case 2:
                        ...
                        contract = this.getContract();
                        method = contract.methods.acceptPrivateDataExchange(exchangeIndex, encryptedDataSecretKey);
                        return [4 /*yield*/, tx_1.configureSendMethod(this.harmony, method, status.passportOwnerAddress, {
    ...
    PrivateDataExchanger.prototype.timeout = function (exchangeIndex, txExecutor) {
        return __awaiter(this, void 0, void 0, function () {
            var status, nowMinus1Min, contract, method, txConfig;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getStatus(exchangeIndex)];
                    case 1:
                        ...
                        contract = this.getContract();
                        method = contract.methods.timeoutPrivateDataExchange(exchangeIndex);
                        return [4 /*yield*/, tx_1.configureSendMethod(this.harmony, method, status.requesterAddress, {
    ...
    PrivateDataExchanger.prototype.dispute = function (exchangeIndex, exchangeKey, txExecutor) {
        return __awaiter(this, void 0, void 0, function () {
            var status, nearFuture, exchangeKeyHash, contract, method, txConfig, receipt, logs, event, params, success, cheater;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getStatus(exchangeIndex)];
                    case 1:
                        ...
                        contract = this.getContract();
                        method = contract.methods.disputePrivateDataExchange(exchangeIndex, exchangeKey);
                        return [4 /*yield*/, tx_1.configureSendMethod(this.harmony, method, status.requesterAddress, {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        contract = this.getContract();
                        method = contract.methods.finishPrivateDataExchange(exchangeIndex);
                        return [4 /*yield*/, tx_1.configureSendMethod(this.harmony, method, requesterOrPassOwnerAddress, {
                                value: status.requesterStaked,
                            })];
                    case 2:
                        txConfig = _a.sent();
    ...
    PrivateDataExchanger.prototype.getStatus = function (exchangeIndex) {
        return __awaiter(this, void 0, void 0, function () {
            var contract, method, rawStatus, status;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        contract = this.getContract();
                        method = contract.methods.privateDataExchanges(exchangeIndex);
                        return [4 /*yield*/, tx_1.callMethod(method)];
                    case 1:
                        rawStatus = _a.sent();
                        if (!rawStatus) {
                            throw SdkError_1.createSdkError(ErrorCode_1.ErrorCode.ExchangeNotFound, "Data exchange with index " + exchangeIndex.toString(10) + " was not found");
                        }
                        status = {
